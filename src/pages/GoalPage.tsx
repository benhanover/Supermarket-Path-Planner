    ...
    <div className="relative min-h-screen font-sans bg-gradient-to-br from-white to-purple-50 overflow-hidden">
      ...
      <main className="py-20 px-6 animate-fade-in text-center">
        <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
          ...
          />
          <h2 className="text-5xl font-extrabold text-cyan-800 mb-4 tracking-tight">Our Goal</h2>
          ...
          <section className="bg-white bg-opacity-60 backdrop-blur-md rounded-xl p-10 shadow-xl w-full max-w-5xl text-left">
            <div className="space-y-10">
              <div className="">
                <h3 className="text-2xl font-bold text-cyan-800 mb-2">Why We Built This</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  <h4 className="text-xl font-semibold text-cyan-700 mb-2">Efficiency</h4>
                ...
                <div>
                  <h4 className="text-xl font-semibold text-cyan-700 mb-2">Adaptability</h4>
                  <ul className="list-disc list-inside text-gray-700 text-base space-y-1">
              ...
              <div className="mt-8 delay-300">
                <p className="text-lg text-gray-800 font-medium">
                  <span className="font-bold text-cyan-800">Our Vision:</span> Intelligent, responsive supermarket planning for a better shopping experience.
                </p>
              </div>
            </div>
          </section>
