    ...
    <div className="relative min-h-screen font-sans bg-gradient-to-br from-white to-purple-50 overflow-hidden">
      ...
      <main className="py-20 px-6 animate-fade-in text-center">
        <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
          ...
          />
          <h2 className="text-5xl font-extrabold text-cyan-800 mb-4 tracking-tight">
            About Our Tool
          </h2>
          <p className="text-gray-700 text-2xl font-light leading-relaxed mb-10">
            ...
            Just a smooth, guided experience to save your time. 🚀
          </p>
            ...
            <div className="space-y-10">
              <div className="">
                <h3 className="text-2xl font-bold text-cyan-800 mb-2">
                  Optimizing the Shopping Experience with Cloud Technology
                </h3>
                <p className="text-gray-700 text-lg leading-relaxed">
                  In a world where time is one of our most valuable resources,
                  grocery shopping often remains an inefficient and
                  time-consuming task. Our solution, the Supermarket Path
                  Planner, is here to change that.
                </p>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  <h4 className="text-xl font-semibold text-cyan-700 mb-2">
              ...
              <div className="mt-8">
                <p className="text-lg text-gray-800 font-medium">
                  <span className="font-bold text-cyan-800">Key Point:</span>{" "}
                  Both customers and store owners need a real-time, efficient
                  navigation solution.
                </p>
              </div>
              ...
              <div className="mt-10 text-sm text-gray-500">
                <p>
                  ...
                  Guy Sofer, Ben Hanover, Alicia Belhassen
                </p>
              </div>
            </div>
          </section>
