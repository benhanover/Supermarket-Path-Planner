    ...
    <div className="relative min-h-screen font-sans bg-gradient-to-br from-white to-purple-50 overflow-hidden">
      ...
      <main className="py-20 px-6 animate-fade-in text-center">
        <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
          ...
          />
          <h2 className="text-5xl font-extrabold text-cyan-800 mb-4 tracking-tight">About Our Tool</h2>
          ...
          <section className="bg-white bg-opacity-60 backdrop-blur-md rounded-xl p-10 shadow-xl w-full max-w-5xl text-left">
            <div className="space-y-10">
              <div className="">
                <h3 className="text-2xl font-bold text-cyan-800 mb-2">Optimizing the Shopping Experience with Cloud Technology</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  <h4 className="text-xl font-semibold text-cyan-700 mb-2">Customer Perspective</h4>
                ...
                <div>
                  <h4 className="text-xl font-semibold text-cyan-700 mb-2">Store Owner Perspective</h4>
                  <ul className="list-disc list-inside text-gray-700 text-base space-y-1">
              ...
              <div className="mt-8">
                <p className="text-lg text-gray-800 font-medium">
                  <span className="font-bold text-cyan-800">Key Point:</span> Both customers and store owners need a real-time, efficient navigation solution.
                </p>
              </div>
