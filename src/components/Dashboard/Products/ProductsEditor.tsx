...
//   const { supermarket, setSupermarket, selectedSquare, setSelectedSquare } =
//     useDashboard();
...
//   if (!supermarket) return <div>Loading...</div>;
...
//         ? {
//             ...prevSupermarket,
//             products: [...prevSupermarket.products, newProduct],
//           }
//         : prevSupermarket
//     );
//   };
...
//       const updatedProducts = prevSupermarket.products.filter(
//         (p) => p.id !== productId
//       );

//       // Remove product from all squares
//       const updatedGrid = prevSupermarket.layout.grid.map((row) =>
//         row.map((square) => ({
//           ...square,
...
//     // Update selected square if necessary
//     if (selectedSquare) {
...
//       const updatedProducts = prevSupermarket.products.map((p) =>
//         p.id === updatedProduct.id ? updatedProduct : p
//       );

//       // Update product in all squares
//       const updatedGrid = prevSupermarket.layout.grid.map((row) =>
//         row.map((square) => ({
//           ...square,
...
//   // ✅ Toggle Product Selection for Squares
...
const ProductsEditor = ({ mode }: ProductsEditorProps) => {
  ...
  const removeProduct = (productId: number, e: React.MouseEvent) => {
    // Stop event propagation to prevent triggering the parent div's click
    e.stopPropagation();
